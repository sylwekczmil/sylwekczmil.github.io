...
export const ArrowUpRight = ({ size = 14 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const BookIcon = ({ size = 14 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CertIcon = ({ size = 22 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    aria-hidden="true"
  >
    <path d="M12 2.5 19 5.5v5c0 4.5-3 7.8-7 9-4-1.2-7-4.5-7-9v-5z" />
